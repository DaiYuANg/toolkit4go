...
| `pure_sql` | `sqltmplx` registry、共享 `PageRequest` 分页、`sqlexec.List/Get/Find/Scalar`、statement 名称日志、`tx.SQL().Exec(...)` | [examples/dbx/pure_sql](https://github.com/DaiYuANg/arcgo/tree/main/examples/dbx/pure_sql) |
